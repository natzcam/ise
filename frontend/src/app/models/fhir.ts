...
export namespace fhir {
  ...
  /**
   * A date, date-time or partial date (e.g. just year or year + month).  If hours and minutes are specified, a time zone SHALL be populated. The format is a union of the schema types gYear, gYearMonth, date and dateTime. Seconds must be provided due to schema export type constraints but may be zero-filled and may be ignored.                 Dates SHALL be valid dates.
   */
  ...
  export interface Attachment extends Element {
    /**
     * Mime export type of the content, with charset etc.
     */
    contentType?: code;
    /**
  ...
  export interface ResourceBase {
    /**
     * The export type of the resource.
     */
    resourceType?: code;
    /**
  ...
  export interface ActivityDefinition extends DomainResource {
    ...
    _kind?: Element;
    /**
     * Detail export type of activity
     */
    code?: CodeableConcept;
    /**
...
An adverse event is an event that caused harm to a patient,  an adverse reaction is a something that is a subject-specific event that is a result of an exposure to a medication, food, device or environmental substance, a potential adverse event is something that occurred and that could have caused harm to a patient but did not
  ...
  export interface AuditEventAgentNetwork extends BackboneElement {
    ...
    _address?: Element;
    /**
     * The export type of network access point
     */
    type?: code;
    /**
     * Contains extended information for property 'type'.
  ...
  export interface AuditEventSource extends BackboneElement {
    ...
    identifier: Identifier;
    /**
     * The export type of source where event originated
     */
    type?: Coding[];
  }
  /**
  ...
  export interface CapabilityStatementRestSecurityCertificate extends BackboneElement {
    /**
     * Mime export type for certificates
     */
    type?: code;
    /**
     * Contains extended information for property 'type'.
  ...
  export interface CapabilityStatementRestResource extends BackboneElement {
    /**
     * A resource export type that is supported
     */
    type: code;
    /**
     * Contains extended information for property 'type'.
  ...
  export interface CapabilityStatementRestResourceInteraction extends BackboneElement {
    /**
     * read | vread | update | patch | delete | history-instance | history-export type | create | search-type
     */
    code: code;
    /**
     * Contains extended information for property 'code'.
  ...
  export interface ChargeItemParticipant extends BackboneElement {
    /**
     * What export type of performance was done
     */
    role?: CodeableConcept;
    /**
  ...
  export interface Claim extends DomainResource {
    ...
    type?: CodeableConcept;
    /**
     * Finer grained claim export type information
     */
  ...
  export interface Contract extends DomainResource {
    ...
    type?: CodeableConcept;
    /**
     * Subexport type within the context of type
     */
    subType?: CodeableConcept[];
    /**
  ...
  export interface ElementDefinitionSlicingDiscriminator extends Element {
    /**
     * value | exists | pattern | export type | profile
     */
    type: code;
    /**
     * Contains extended information for property 'type'.
  ...
  /**
   * Data export type and Profile for this element
   */
  export interface ElementDefinitionType extends Element {
    /**
     * Data export type or Resource (reference to definition)
     */
    code: uri;
    /**
     * Contains extended information for property 'code'.
   ...
   * Benefit Summary
   */
  export interface EligibilityResponseInsuranceBenefitBalanceFinancial
    extends BackboneElement {
    /**
  ...
  export interface EncounterHospitalization extends BackboneElement {
    ...
    /**
     * The export type of hospital re-admission that has occurred (if any). If the value is absent, then this is not identified as a readmission
     */
  ...
  export interface Encounter extends DomainResource {
    ...
    /**
     * Specific export type of encounter
     */
    type?: CodeableConcept[];
    /**
  ...
  export interface Endpoint extends DomainResource {
    ...
    period?: Period;
    /**
     * The export type of content that may be used at this endpoint (e.g. XDS Discharge summaries)
     */
    payloadType: CodeableConcept[];
    /**
     * Mimeexport type to send. If not specified, the content could be anything (including no payload, if the connectionType defined this)
     */
   ...
   * The designation to be included
   */
  export interface ExpansionProfileDesignationIncludeDesignation
    extends BackboneElement {
    /**
   ...
   * The designation to be excluded
   */
  export interface ExpansionProfileDesignationExcludeDesignation
    extends BackboneElement {
    /**
  ...
  export interface ExplanationOfBenefitItemDetail extends BackboneElement {
    ...
    _sequence?: Element;
    /**
     * Group or export type of product or service
     */
    type: CodeableConcept;
    /**
     * Revenue or cost center code
  ...
  export interface DataRequirement extends Element {
    /**
     * The export type of the required data
     */
    type: code;
    /**
     * Contains extended information for property 'type'.
   ...
   * Protocol used by recommendation
   */
  export interface ImmunizationRecommendationRecommendationProtocol
    extends BackboneElement {
    /**
  ...
  export interface Media extends DomainResource {
    ...
    _type?: Element;
    /**
     * The export type of acquisition equipment/process
     */
    subtype?: CodeableConcept;
    /**
  ...
  /**
   * A resource that defines a export type of message that can be exchanged between systems
   */
  ...
  export interface NutritionOrder extends DomainResource {
    ...
    /**
     * Order-specific modifier about the export type of food that should be given
     */
    foodPreferenceModifier?: CodeableConcept[];
    /**
     * Order-specific modifier about the export type of food that should not be given
     */
  ...
  export interface Observation extends DomainResource {
    ...
    _status?: Element;
    /**
     * Classification of  export type of observation
     */
    category?: CodeableConcept[];
    /**
  ...
  export interface OperationDefinitionParameter extends BackboneElement {
    ...
    _documentation?: Element;
    /**
     * What export type this parameter has
     */
    type?: code;
    /**
     * Contains extended information for property 'type'.
  ...
  export interface OperationDefinition extends DomainResource {
    ...
    _system?: Element;
    /**
     * Invole at the export type level?
     */
    type: boolean;
    /**
     * Contains extended information for property 'type'.
  ...
  export interface PatientLink extends BackboneElement {
    ...
    other: Reference;
    /**
     * replaced-by | replaces | refer | seealso - export type of link
     */
    type: code;
    /**
     * Contains extended information for property 'type'.
  ...
  export interface Slot extends DomainResource {
    ...
    serviceCategory?: CodeableConcept;
    /**
     * The export type of appointments that can be booked into this slot (ideally this would be an identifiable service - which is at a location, rather than the location itself). If provided then this overrides the value provided on the availability resource
     */
    serviceType?: CodeableConcept[];
    /**
     * The specialty of a practitioner that would be required to perform the service requested in this appointment
  ...
  export interface StructureDefinition extends DomainResource {
    ...
    /**
     * primitive-export type | complex-export type | resource | logical
     */
    kind: code;
    /**
     * Contains extended information for property 'kind'.
    ...
    _abstract?: Element;
    /**
     * resource | dataexport type | extension
     */
    contextType?: code;
    /**
    ...
    _type?: Element;
    /**
     * Definition that this export type is constrained/specialized from
     */
    baseDefinition?: uri;
    /**
  ...
  export interface StructureMapStructure extends BackboneElement {
    ...
    _mode?: Element;
    /**
     * Name for export type in this map
     */
    alias?: string;
    /**
     * Contains extended information for property 'alias'.
  ...
  export interface SubscriptionChannel extends BackboneElement {
    ...
    _endpoint?: Element;
    /**
     * Mimeexport type to send, or omit for no payload
     */
    payload?: string;
    /**
  ...
  export interface Substance extends DomainResource {
    ...
    _status?: Element;
    /**
     * What class/export type of substance this is
     */
    category?: CodeableConcept[];
    /**
  ...
  export interface TestScriptSetupActionOperation extends BackboneElement {
    /**
     * The operation code export type that will be executed
     */
    type?: Coding;
    /**
     * Resource type
   ...
   * Rule parameter template
   */
  export interface TestScriptSetupActionAssertRulesetRuleParam
    extends BackboneElement {
    /**
     * Parameter name matching external assert ruleset rule parameter
     */
  ...
  /**
   * Reference to a sub-export type of ResourceBase. This is needed for stricter object literal typing introduced in TypeScript 1.6.
   */
